...
$sql ='UPDATE students SET firstname=:cfirstname,surname =:csurname,phoneNumber =:cphoneNumber, email =:cemail, lessonsDone =:clessonsDone WHERE studentID =:cid';
...
$result->bindValue(':clessonsDone', $_POST['ud_lessonsDone']);
$result->execute();
...
if ($count > 0)
{
echo "<br><br><h2>You just updated Student no: " . $_POST['ud_id'] ."  click<a href='selectupdate.php'> here</a> to go back </h2><br>";
}
else
{
